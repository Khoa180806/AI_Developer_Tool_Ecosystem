# Codebase Graph — Benchmark Context

Extracted from `docs/10_BENCHMARK_PLAN.md` for tool-local reference.
The authoritative source remains `docs/10_BENCHMARK_PLAN.md`.
